...
export default function EditMangaPage() {
    ...
    const [formData, setFormData] = useState({ title: '', author: '', description: '', status: 'ongoing' });
    ...
    useEffect(() => {
        async function loadData() {
            try {
                ...
                setFormData({ title: manga.title || '', author: manga.author || '', description: manga.description || '', status: manga.status || 'ongoing' });
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            const res = await fetch(`${API_URL}/manga/${mangaId}/`, {
                ...
                body: JSON.stringify({ ...formData, cover_image_url: coverUrl, genres: selectedGenres, category: selectedCategory || null }),
            });
