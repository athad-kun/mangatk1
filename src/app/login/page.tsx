...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // محاكاة تأخير الشبكة (كأننا نتصل بسيرفر حقيقي)
    setTimeout(() => {
      // 3. استدعاء دالة الدخول وتمرير الاسم (أخذناه من الايميل) والايميل
      // مثال: user@test.com -> الاسم سيكون "user"
      const nameFromEmail = email.split('@')[0];
      login(nameFromEmail, email);
